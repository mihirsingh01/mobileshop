...
def add_product_view(request):
    ...
    return render(request, 'accessories_staff/add_product.html')

@login_required
def product_list_view(request):
    products = Product.objects.all()
    return render(request, 'accessories_staff/product_list.html', {'products': products})
...
def add_sale_view(request):
    ...
    products = Product.objects.all()
    return render(request, 'accessories_staff/add_sale.html', {'products': products})
